...
import argparse
from probe_training_utils import TrainingParams, SingleProbe, LinearProbeData
...
def populate_probes_dict(
    ...
    for layer in layers:
        ...
        linear_probe_name = (
            f"{SAVED_PROBE_DIR}tf_lens_dummy_8layers_ckpt_no_optimizer_{config.linear_probe_name}_layer_{layer}.pth"
        )
...
#        dataset_prefix = "lichess_"
        ...
        split = "train"
        n_layers = 8
        model_name = f"tf_lens_random_{n_layers}layers_ckpt_no_optimizer"
