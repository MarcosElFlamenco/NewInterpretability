...
if __name__ == "__main__":
    ...
    if args.mode == "test":
        ...
        print(f"Running the following test \
            \n Testing probes of type {args.probe_dataset} \
            \n On the residual stream generated by the following model {args.model_name} \
            \n When applied to the {args.test_games_dataset} dataset")
